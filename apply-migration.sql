-- Run this SQL script in your Supabase SQL Editor to apply the enhanced features migration
-- Go to: https://0ec90b57d6e95fcbda19832f.supabase.co (your Supabase project)
...
-- =====================================================
-- 8. POST-MIGRATION INSTRUCTIONS
-- =====================================================

-- After running this migration:
-- 1. Create the admin user through Supabase Auth or your registration page
-- 2. Run this command to promote them to admin:
--    SELECT promote_user_to_admin('support@abor-tech.com');
-- 3. Configure email service in Supabase (SMTP or Resend integration)
-- 4. Deploy the edge functions for email notifications
